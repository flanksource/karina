...
type Vault struct {
	...
	Roles         map[string]Values      `yaml:"roles,omitempty"`
	...
	ExtraConfig map[string]Values `yaml:"config,omitempty"`
	Disabled    bool              `yaml:"disabled,omitempty"`
	AccessKey   string            `yaml:"accessKey,omitempty"`
	SecretKey   string            `yaml:"secretKey,omitempty"`
...
func (i *Values) MarshalYAML() (interface{}, error) {
	return yaml.Marshal(i.inner)
}

// MarshalJSON for Values
func (i *Values) MarshalJSON() (interface{}, error) {
