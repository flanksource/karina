...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GithubOIDC) DeepCopyInto(out *GithubOIDC) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GithubOIDC.
func (in *GithubOIDC) DeepCopy() *GithubOIDC {
	if in == nil {
		return nil
	}
	out := new(GithubOIDC)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Modsecurity) DeepCopyInto(out *Modsecurity) {
	*out = *in
	if in.Elasticsearch != nil {
		in, out := &in.Elasticsearch, &out.Elasticsearch
		*out = new(Connection)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Modsecurity.
func (in *Modsecurity) DeepCopy() *Modsecurity {
	if in == nil {
		return nil
	}
	out := new(Modsecurity)
...
func (in *Monitoring) DeepCopyInto(out *Monitoring) {
	*out = *in
	...
	if in.ExcludeAlerts != nil {
		in, out := &in.ExcludeAlerts, &out.ExcludeAlerts
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *Nginx) DeepCopyInto(out *Nginx) {
	*out = *in
	...
	if in.Modsecurity != nil {
		in, out := &in.Modsecurity, &out.Modsecurity
		*out = new(Modsecurity)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *PlatformConfig) DeepCopyInto(out *PlatformConfig) {
	*out = *in
	...
	out.CanaryChecker = in.CanaryChecker
	...
	out.S3 = in.S3
	in.SealedSecrets.DeepCopyInto(&out.SealedSecrets)
	out.SMTP = in.SMTP
	if in.Specs != nil {
