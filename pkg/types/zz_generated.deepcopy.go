...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OPAE2E) DeepCopyInto(out *OPAE2E) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OPAE2E.
func (in *OPAE2E) DeepCopy() *OPAE2E {
	if in == nil {
		return nil
	}
	out := new(OPAE2E)
...
func (in *PlatformConfig) DeepCopyInto(out *PlatformConfig) {
	*out = *in
	...
	if in.PostgresOperator != nil {
		in, out := &in.PostgresOperator, &out.PostgresOperator
	...
	if in.PlatformOperator != nil {
		in, out := &in.PlatformOperator, &out.PlatformOperator
	...
	if in.TmpFiles != nil {
		in, out := &in.TmpFiles, &out.TmpFiles
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
