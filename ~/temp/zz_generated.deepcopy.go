...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageVersions) DeepCopyInto(out *ImageVersions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageVersions.
func (in *ImageVersions) DeepCopy() *ImageVersions {
	if in == nil {
		return nil
	}
	out := new(ImageVersions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Kpack) DeepCopyInto(out *Kpack) {
	*out = *in
	out.ImageVersions = in.ImageVersions
}
